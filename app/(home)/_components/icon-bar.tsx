    ...
    <div className="bg-black relative flex items-center justify-center">
      ...
      <div className="flex items-center justify-between absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-[60%]">
        <div className="text-center flex flex-col justify-center items-center">
          <Image src={Games} alt="Games icon" className="mb-1" />
        ...
        <div className="text-center flex flex-col justify-center items-center">
          <Image src={GiftCards} alt="Gift cards icon" className="mb-1" />
          <p className="text-white font-primaryFont font-semibold text-[20px]">
            Gift Cards
          </p>
        </div>
        ...
        <div className="text-center flex flex-col justify-center items-center">
          <Image src={EMoeny} alt="E-money icon" className="mb-1" />
          <p className="text-white font-primaryFont font-semibold text-[20px]">
            E-Money
          </p>
        </div>
        ...
        <div className="text-center flex flex-col justify-center items-center">
          <Image src={PreOders} alt="Pre-orders icon" className="mb-1" />
          <p className="text-white font-primaryFont font-semibold text-[20px]">
            Pre-Orders
          </p>
        </div>
        ...
        <div className="text-center flex flex-col justify-center items-center">
          <Image src={Steam} alt="Steam icon" className="mb-1" />
          <p className="text-white font-primaryFont font-semibold text-[20px]">
            Steam
          </p>
        </div>
