    ...
    <div
      className={`${
        isMobileNavToggled
          ...
          : "hidden"
      } absolute w-[16em] bg-black/60 font-secondaryFont text-[12px] text-white min-h-screen pt-[2.5em] border-t border-e border-[#0D6D49] z-50 md:relative sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-base`}
    >
      <ul>
        {/* Dashboard Section */}
        <button
